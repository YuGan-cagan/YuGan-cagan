	...
	public function init(ChunkManager $level, Random $random){
		...
		$this->selector = new BiomeSelector($this->random, function($temperature, $rainfall){
			if($rainfall < 0.25){
				...
				if($temperature < 0.25){
					return Biome::NEWICEPLAINS;
						}
						else
						{
					return Biome::ICEMOUNTAINS;	
					}
				...
				if($temperature < 0.25){
					return Biome::NEWMOUNTAINS;
				}elseif($temperature < 0.70){
					return Biome::MOUNTAINS;
				}else{
					return Biome::GRAVEL_MOUNTAINS;
				if($temperature < 0.25){
		...
		$this->selector->addBiome(Biome::getBiome(Biome::NEWMOUNTAINS));
		...
		$this->selector->addBiome(Biome::getBiome(Biome::SAVANNAPLAIN));
		$this->selector->addBiome(Biome::getBiome(Biome::SAVANNAPLATEAU));
		$this->selector->addBiome(Biome::getBiome(Biome::HILLY));
		$this->selector->addBiome(Biome::getBiome(Biome::ICE_PLAINS));
		$this->selector->addBiome(Biome::getBiome(Biome::SMALL_MOUNTAINS));
		$this->selector->addBiome(Biome::getBiome(Biome::GRAVEL_MOUNTAINS));
		$this->selector->addBiome(Biome::getBiome(Biome::BIRCH_FOREST));
		$this->selector->addBiome(Biome::getBiome(Biome::NEWICEPLAINS));
		$this->selector->addBiome(Biome::getBiome(Biome::MUSHROOMISLAND));
		$this->selector->addBiome(Biome::getBiome(Biome::SNOWMOUNTAINS));
		$this->selector->addBiome(Biome::getBiome(Biome::DRAKFOREST));
			...
			for($z = 0; $z < 16; ++$z){
				...
				for($y = 127; $y >= 0; --$y){
					...
					if($noiseValue > 0){
						...
						$solidLand = true;
					}elseif($y <= $this->waterHeight && $solidLand == true){
